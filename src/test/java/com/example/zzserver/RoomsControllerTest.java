...
public class RoomsControllerTest {
        ...
        public void accommodationAccommodationId() throws Exception {
                ...
                when(roomsService.getAllByAccommodation(accommodationId))
                                .thenReturn(List.of(roomsResponse, roomsResponse2, roomsResponse3, roomsResponse4));
        ...
        // .build();
        //
        // when(roomsService.update(Mockito.any(),
        // Mockito.any())).thenReturn(roomsResponse5);
        //
        // mockMvc.perform(
